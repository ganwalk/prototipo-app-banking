...
export function PhoneFrame({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-svh w-full bg-[radial-gradient(ellipse_at_top,_#0e2a1b_0%,_#01110a_65%)] flex items-center justify-center sm:p-10">
      <div
        className="relative w-full h-svh bg-white overflow-hidden
